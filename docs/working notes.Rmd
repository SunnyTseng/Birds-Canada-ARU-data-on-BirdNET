...
-   Noticed that the target species, Yellow Rail, might not be included in the detection list. Double check with David again to see whether re-run the analysis is needed. Do one only for the Yellow-Rail.

### Mar. 4, 2024

-   Provided invoice to Birds Canada

-   Re-run the focal species analysis on sites. Found issues with some sites (no .csv files got saved with unknown reason)

-   Report the issue and submit the data that I have to Birds Canada David Bradley
